package org.understandinguncertainty.personal
{
	...
	public class VariableList {
		...
		public var dateOfBirth:DateOfBirth = new DateOfBirth("dateOfBirth", new Date());
		...
		public var ethnicGroup:NumberPersonalVariable = new NumberPersonalVariable("ethnicGroup", "white");
		...
		public function clone():VariableList
		{
			...
			copy.age.value = age.value;
			copy.active.value = active.value;
			copy.fiveaday.value = fiveaday.value;
			copy.gender.value = gender.value;
			copy.moderateAlcohol.value = moderateAlcohol.value;
			copy.nonSmoker.value = nonSmoker.value;
			copy.dateOfBirth.value = dateOfBirth.value;
			copy.yearOfBirth.value = yearOfBirth.value;
			copy.totalCholesterol_mmol_L.value = totalCholesterol_mmol_L.value;
			copy.hdlCholesterol_mmol_L.value = hdlCholesterol_mmol_L.value;
			copy.systolicBloodPressure.value = systolicBloodPressure.value;
			copy.height_m.value = height_m.value;
			copy.weight_kg.value = weight_kg.value;
			copy.SBPTreated.value = SBPTreated.value;
			copy.diabetic.value = diabetic.value;
			return copy;
		}
		*/
